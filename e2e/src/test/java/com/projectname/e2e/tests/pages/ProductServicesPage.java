...
public class ProductServicesPage extends PageBase {
    public ProductServicesPage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()) {
            ...
            if(navigationBarPage.isDisplayed()) {
                navigationBarPage.openProductServicesPage();
            }
        }
        return this;
    }
