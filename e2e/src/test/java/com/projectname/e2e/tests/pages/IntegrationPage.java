...
public class IntegrationPage extends PageBase {
    public IntegrationPage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()) {
            ...
            if(navigationBarPage.isDisplayed()) {
                navigationBarPage.openIntegrationPage();
            }
        }
        return this;
    }
